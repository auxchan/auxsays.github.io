---
layout: aux-update
title: DaVinci Resolve 15.2.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/15-2-1/
update_entry: true
...
update_version: 15.2.1
update_logo_text: DAV
update_published_at: '2018-11-29T00:00:00Z'
...
update_feed_title: DaVinci Resolve 15.2.1
update_detail_title: DaVinci Resolve 15.2.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 15.2.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve 15.2.1 in its official support downloads feed.
release_summary: This software update provides performance improvements for MXF OP1A rendering, keyboard shortcuts, match
  frame focus, 10-bit DPX playback, optical flow image processing, audio routing, Fusion transform tool offsets and much more.
  This update also includes stability improvements and is recommended for all DaVInci Resolve 15 users. Technical support
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve 15.2.1
  ...
  This software update provides performance improvements for MXF OP1A rendering, keyboard shortcuts, match frame focus, 10-bit
  DPX playback, optical flow image processing, audio routing, Fusion transform tool offsets and much more. This update also
  includes stability improvements and is recommended for all DaVInci Resolve 15 users. Technical support for the free version

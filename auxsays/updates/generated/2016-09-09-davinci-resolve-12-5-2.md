---
layout: aux-update
title: DaVinci Resolve 12.5.2 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/12-5-2/
update_entry: true
...
update_version: 12.5.2
update_logo_text: DAV
update_published_at: '2016-09-09T00:00:00Z'
...
update_feed_title: DaVinci Resolve 12.5.2
update_detail_title: DaVinci Resolve 12.5.2
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 12.5.2 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve 12.5.2 Update in its official support downloads feed.
release_summary: This software update adds support for additional metadata embedded into the RAW files from URSA Mini cameras
  running the new operating software, new color space tag support on QuickTime export, Fusion Connect for Linux, additional
  smart bin options, new color page timeline filtering based on OpenFX plug-ins and more. Technical support is available via
  the Blackmagic Design community forums.
...
complaint_themes: []
status_events:
- at: '2016-09-09T00:00:00Z'
  label: Published
  note: Official source entry detected.
- at: '2026-08-12T20:42:56Z'
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve 12.5.2 Update
  ...
  This software update adds support for additional metadata embedded into the RAW files from URSA Mini cameras running the
  new operating software, new color space tag support on QuickTime export, Fusion Connect for Linux, additional smart bin
  options, new color page timeline filtering based on OpenFX plug-ins and more. Technical support is available via the Blackmagic

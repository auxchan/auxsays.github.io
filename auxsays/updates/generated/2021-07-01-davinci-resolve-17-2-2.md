---
layout: aux-update
title: DaVinci Resolve 17.2.2 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/17-2-2/
update_entry: true
...
update_version: 17.2.2
update_logo_text: DAV
update_published_at: '2021-07-01T00:00:00Z'
...
update_feed_title: DaVinci Resolve 17.2.2
update_detail_title: DaVinci Resolve 17.2.2
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 17.2.2 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 17.2.2 Update in its official support downloads feed.
release_summary: This software update adds support for Blackmagic RAW 2.1, improved Bluetooth connectivity for DaVinci Resolve
  Speed Editor and better YouTube credential recognition. This update also adds improvements to color mapping and source viewer
  playback as well as general performance and stability improvements. This version requires a DaVinci Resolve Studio license
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 17.2.2 Update
  ...
  This software update adds support for Blackmagic RAW 2.1, improved Bluetooth connectivity for DaVinci Resolve Speed Editor
  and better YouTube credential recognition. This update also adds improvements to color mapping and source viewer playback
  as well as general performance and stability improvements. This version requires a DaVinci Resolve Studio license dongle

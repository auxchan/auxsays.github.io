---
layout: aux-update
title: DaVinci Resolve 18.5 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/18-5/
update_entry: true
...
update_published_at: '2023-07-21T00:00:00Z'
...
update_feed_title: DaVinci Resolve 18.5
update_detail_title: DaVinci Resolve 18.5
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 18.5 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until the
  consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 18.5 Update in its official support downloads feed.
release_summary: This software update installs the final release of DaVinci Resolve Studio 18.5 which adds support for new
  AI tools, as well as over 100 new features including text based editing, AI dialogue transcription, new cut page editing
  toolset, new Fairlight audio mix automation and Universal Scene Description file support. This version requires a DaVinci
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 18.5 Update
  ...
  This software update installs the final release of DaVinci Resolve Studio 18.5 which adds support for new AI tools, as well
  as over 100 new features including text based editing, AI dialogue transcription, new cut page editing toolset, new Fairlight
  audio mix automation and Universal Scene Description file support. This version requires a DaVinci Resolve Studio license

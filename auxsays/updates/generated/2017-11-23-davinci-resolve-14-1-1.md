---
layout: aux-update
title: DaVinci Resolve 14.1.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/14-1-1/
update_entry: true
...
update_version: 14.1.1
update_logo_text: DAV
update_published_at: '2017-11-23T00:00:00Z'
...
update_feed_title: DaVinci Resolve 14.1.1
update_detail_title: DaVinci Resolve 14.1.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 14.1.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve 14.1.1 in its official support downloads feed.
release_summary: This software update fixes a bug when detecting Blackmagic Desktop Video hardware, improves monitoring selection
  of PsF formats, provides better license dongle detection on MacOS High Sierra. In addition, this update has many general
  performance and stability improvements, and is recommended for all DaVinci Resolve 14 users. Technical support for the free
  version is available via the Blackmagic Design web forums only.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve 14.1.1
  ...
  This software update fixes a bug when detecting Blackmagic Desktop Video hardware, improves monitoring selection of PsF
  formats, provides better license dongle detection on MacOS High Sierra. In addition, this update has many general performance
  and stability improvements, and is recommended for all DaVinci Resolve 14 users. Technical support for the free version

---
layout: aux-update
title: DaVinci Resolve 18.0.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/18-0-1/
update_entry: true
...
update_version: 18.0.1
update_logo_text: DAV
update_published_at: '2022-07-26T00:00:00Z'
...
update_feed_title: DaVinci Resolve 18.0.1
update_detail_title: DaVinci Resolve 18.0.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 18.0.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 18.0.1 Update in its official support downloads feed.
release_summary: This software update fixes a problem with DNx support as well as improving power grade still saving. This
  update also improves color space selection for upgraded ACES projects and addresses an issue with Fusion’s Mandelbrot tool
  on Apple silicon machines. This version requires a DaVinci Resolve Studio license dongle or software activation code.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 18.0.1 Update
  ...
  This software update fixes a problem with DNx support as well as improving power grade still saving. This update also improves
  color space selection for upgraded ACES projects and addresses an issue with Fusion’s Mandelbrot tool on Apple silicon machines.

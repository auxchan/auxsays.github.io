---
layout: aux-update
title: DaVinci Resolve 18.6.5 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/18-6-5/
update_entry: true
...
update_version: 18.6.5
update_logo_text: DAV
update_published_at: '2024-02-07T00:00:00Z'
update_last_checked: '2026-07-24T08:45:08Z'
source_last_checked: '2026-07-24T08:45:08Z'
official_body_last_checked: '2026-07-24T08:45:08Z'
record_last_updated: '2026-07-24T08:45:08Z'
patch_file_size: ''
patch_file_size_note: Blackmagic support-download metadata does not expose installer file size.
patch_file_size_status: not_provided_by_source
update_status: current
update_feed_title: DaVinci Resolve 18.6.5
update_detail_title: DaVinci Resolve 18.6.5
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 18.6.5 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 18.6.5 Update in its official support downloads feed.
release_summary: This software update adds support for Blackmagic RAW 3.6.1 and Sony Burano files, as well as the ability
  to import and export compound clips and clip markers in Open TimelineIO. DaVinci Resolve Studio 18.6.5 also adds AI stabilization
  for Blackmagic Cinema Camera 6K and Micro Studio Camera 4K G2 footage, better EXR file labeling and improved shortcut functionality
  for multiple clip selections. This version requires a DaVinci Resolve Studio license dongle or software activation code.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 18.6.5 Update
  ...
  This software update adds support for Blackmagic RAW 3.6.1 and Sony Burano files, as well as the ability to import and export
  compound clips and clip markers in Open TimelineIO. DaVinci Resolve Studio 18.6.5 also adds AI stabilization for Blackmagic
  Cinema Camera 6K and Micro Studio Camera 4K G2 footage, better EXR file labeling and improved shortcut functionality for
  multiple clip selections. This version requires a DaVinci Resolve Studio license dongle or software activation code.

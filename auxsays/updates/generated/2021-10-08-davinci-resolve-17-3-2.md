---
layout: aux-update
title: DaVinci Resolve 17.3.2 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/17-3-2/
update_entry: true
...
update_version: 17.3.2
update_logo_text: DAV
update_published_at: '2021-10-08T00:00:00Z'
...
record_last_updated: '2026-07-31T14:40:05Z'
patch_file_size: ''
patch_file_size_note: Blackmagic support-download metadata does not expose installer file size.
patch_file_size_status: not_provided_by_source
update_status: current
update_feed_title: DaVinci Resolve 17.3.2
update_detail_title: DaVinci Resolve 17.3.2
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 17.3.2 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 17.3.2 Update in its official support downloads feed.
release_summary: This software update adds support for Blackmagic RAW 2.2, improved stability when using the color warper
  tool and better highlight rendering in the wide gamut color space. This update also adds improvements to clip naming functionality
  in Fairlight and more consistent loading of EQ and automation adjustments, as well as general performance and stability
  improvements. This version requires a DaVinci Resolve Studio license dongle or software activation code.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 17.3.2 Update
  ...
  This software update adds support for Blackmagic RAW 2.2, improved stability when using the color warper tool and better
  highlight rendering in the wide gamut color space. This update also adds improvements to clip naming functionality in Fairlight
  and more consistent loading of EQ and automation adjustments, as well as general performance and stability improvements.

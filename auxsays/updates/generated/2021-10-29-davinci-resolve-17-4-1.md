---
layout: aux-update
title: DaVinci Resolve 17.4.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/17-4-1/
update_entry: true
...
update_version: 17.4.1
update_logo_text: DAV
update_published_at: '2021-10-29T00:00:00Z'
...
update_feed_title: DaVinci Resolve 17.4.1
update_detail_title: DaVinci Resolve 17.4.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 17.4.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 17.4.1 Update in its official support downloads feed.
release_summary: This software update fixes issues with automatic recognition of HDR displays on Apple Macs and adds a consistent
  approach to frame based clip imports. In addition, this update improves fade trimming behavior on the edit timeline, provides
  better retention of smart filter settings and fixes issues with playback performance and unicode character display for Text+.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 17.4.1 Update
  ...
  This software update fixes issues with automatic recognition of HDR displays on Apple Macs and adds a consistent approach
  to frame based clip imports. In addition, this update improves fade trimming behavior on the edit timeline, provides better
  retention of smart filter settings and fixes issues with playback performance and unicode character display for Text+. This

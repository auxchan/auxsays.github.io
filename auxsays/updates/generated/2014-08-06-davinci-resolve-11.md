...
quick_verdict: DaVinci Resolve 11 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve 11 in its official support downloads feed.
release_summary: DaVinci Resolve 11 includes professional online video editing, new photographer friendly color correction tools, revolutionary ColorMatch test chart auto-grading, on-set media management and more!
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve 11
  ...
  DaVinci Resolve 11 includes professional online video editing, new photographer friendly color correction tools, revolutionary ColorMatch test chart auto-grading, on-set media management and more!

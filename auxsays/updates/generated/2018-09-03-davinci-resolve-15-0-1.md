---
layout: aux-update
title: DaVinci Resolve 15.0.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/15-0-1/
update_entry: true
...
update_version: 15.0.1
update_logo_text: DAV
update_published_at: '2018-09-03T00:00:00Z'
...
record_last_updated: '2026-08-11T03:48:39Z'
patch_file_size: ''
patch_file_size_note: Blackmagic support-download metadata does not expose installer file size.
patch_file_size_status: not_provided_by_source
update_status: current
update_feed_title: DaVinci Resolve 15.0.1
update_detail_title: DaVinci Resolve 15.0.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 15.0.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve 15.0.1 in its official support downloads feed.
release_summary: This software update adds fixes and improvements for dynamic project switching, save speeds, text encoding
  for subtitles, improved RED IPP2 gamut mapping and more. DaVinci Resolve 15.0.1 update also addresses playback issues for
  Fusion clips with premultiplied alpha, makes it possible to render to unmapped drives on Windows, and includes additional
  general performance and stability improvements. Technical support for the free version is available via the Blackmagic Design
  web forums only.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve 15.0.1
  ...
  This software update adds fixes and improvements for dynamic project switching, save speeds, text encoding for subtitles,
  improved RED IPP2 gamut mapping and more. DaVinci Resolve 15.0.1 update also addresses playback issues for Fusion clips
  with premultiplied alpha, makes it possible to render to unmapped drives on Windows, and includes additional general performance

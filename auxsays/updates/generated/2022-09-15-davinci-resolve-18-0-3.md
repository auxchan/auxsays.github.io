---
layout: aux-update
title: DaVinci Resolve 18.0.3 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/18-0-3/
update_entry: true
...
update_version: 18.0.3
update_logo_text: DAV
update_published_at: '2022-09-15T00:00:00Z'
...
update_feed_title: DaVinci Resolve 18.0.3
update_detail_title: DaVinci Resolve 18.0.3
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 18.0.3 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 18.0.3 Update in its official support downloads feed.
release_summary: This software update improves USB-C connectivity with Fairlight Desktop Consoles, adds better rendering of
  clips without color nodes, as well as addressing issues with IMF rendering and deleting empty tracks on imported AAF timelines.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 18.0.3 Update
  ...
  This software update improves USB-C connectivity with Fairlight Desktop Consoles, adds better rendering of clips without
  color nodes, as well as addressing issues with IMF rendering and deleting empty tracks on imported AAF timelines. This version

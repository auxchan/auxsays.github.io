---
layout: aux-update
title: DaVinci Resolve 17.4.3 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/17-4-3/
update_entry: true
...
update_version: 17.4.3
update_logo_text: DAV
update_published_at: '2021-12-21T00:00:00Z'
update_last_checked: '2026-07-31T06:49:25Z'
source_last_checked: '2026-07-31T06:49:25Z'
official_body_last_checked: '2026-07-31T06:49:25Z'
record_last_updated: '2026-07-31T06:49:25Z'
patch_file_size: ''
patch_file_size_note: Blackmagic support-download metadata does not expose installer file size.
patch_file_size_status: not_provided_by_source
update_status: current
update_feed_title: DaVinci Resolve 17.4.3
update_detail_title: DaVinci Resolve 17.4.3
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 17.4.3 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 17.4.3 Update in its official support downloads feed.
release_summary: This software update improves system stability when working on Windows computers, as well as adding better
  character styling behaviour and output blanking. For Fairlight, this software update adds improvements to clip naming, crossfades,
  and audio monitoring. DaVinci Resolve 17.4.3 also adds further improvements to decode performance when working with ProRes
  files on Apple Mac models with M1 Max processors. This version requires a DaVinci Resolve Studio license dongle or software
  activation code.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 17.4.3 Update
  ...
  This software update improves system stability when working on Windows computers, as well as adding better character styling
  behaviour and output blanking. For Fairlight, this software update adds improvements to clip naming, crossfades, and audio
  monitoring. DaVinci Resolve 17.4.3 also adds further improvements to decode performance when working with ProRes files on
  Apple Mac models with M1 Max processors. This version requires a DaVinci Resolve Studio license dongle or software activation
  code.

---
layout: aux-update
title: GitHub / Copilot Copilot Student GPT-5.3-Codex removal from model picker official update breakdown
description: Official GitHub / Copilot update record captured from GitHub.
permalink: /updates/github/github/copilot-student-gpt-5-3-codex-removal-from-model-picker/
update_entry: true
company_id: github
product_id: github
...
update_source_url: https://github.blog/changelog/2026-04-27-copilot-student-gpt-5-3-codex-removal-from-model-picker
update_download_url: ''
update_version: Copilot Student GPT-5.3-Codex removal from model picker
...
update_detail_title: GitHub / Copilot Copilot Student GPT-5.3-Codex removal from model picker

---
layout: aux-update
title: DaVinci Resolve 18.1.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/18-1-1/
update_entry: true
...
update_version: 18.1.1
update_logo_text: DAV
update_published_at: '2022-11-23T00:00:00Z'
...
update_feed_title: DaVinci Resolve 18.1.1
update_detail_title: DaVinci Resolve 18.1.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 18.1.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 18.1.1 Update in its official support downloads feed.
release_summary: This software update adds support for Blackmagic RAW 2.8, display scaling options for Windows and restored
  keyboard shortcuts. In addition, this update improves AI based voice isolation for short audio clips. This version requires
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 18.1.1 Update
  ...
  This software update adds support for Blackmagic RAW 2.8, display scaling options for Windows and restored keyboard shortcuts.
  In addition, this update improves AI based voice isolation for short audio clips. This version requires a DaVinci Resolve

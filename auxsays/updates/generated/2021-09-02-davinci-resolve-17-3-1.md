---
layout: aux-update
title: DaVinci Resolve 17.3.1 official update breakdown
description: Official DaVinci Resolve update record captured from Blackmagic Design.
permalink: /updates/blackmagic-design/blackmagic-davinci/17-3-1/
update_entry: true
...
update_version: 17.3.1
update_logo_text: DAV
update_published_at: '2021-09-02T00:00:00Z'
update_last_checked: '2026-08-01T14:12:34Z'
source_last_checked: '2026-08-01T14:12:34Z'
official_body_last_checked: '2026-08-01T14:12:34Z'
record_last_updated: '2026-08-01T14:12:34Z'
patch_file_size: ''
patch_file_size_note: Blackmagic support-download metadata does not expose installer file size.
patch_file_size_status: not_provided_by_source
update_status: current
update_feed_title: DaVinci Resolve 17.3.1
update_detail_title: DaVinci Resolve 17.3.1
update_consensus_label: Insufficient data
update_report_count: 0
update_consensus_confidence: Low
quick_verdict: DaVinci Resolve 17.3.1 has an official AUXSAYS record. Confirmed patch-specific consensus is deferred until
  the consensus refresh pipeline is active.
official_summary: Blackmagic Design lists DaVinci Resolve Studio 17.3.1 Update in its official support downloads feed.
release_summary: This software update adds the ability to combine multiple source audio files to export as interleaved audio.
  It also improves YouTube and Vimeo sign in for Windows systems and improves middle click behavior when using tablets. DaVinci
  Resolve 17.3.1 Update also adds improved stability when adding stills to memories as well as better Apple ProRes 4444 processing
  on Apple Silicon systems. This version requires a DaVinci Resolve Studio license dongle or software activation code.
...
official_patch_notes_body: 'Official Blackmagic support-download entry: DaVinci Resolve Studio 17.3.1 Update
  ...
  This software update adds the ability to combine multiple source audio files to export as interleaved audio. It also improves
  YouTube and Vimeo sign in for Windows systems and improves middle click behavior when using tablets. DaVinci Resolve 17.3.1
  Update also adds improved stability when adding stills to memories as well as better Apple ProRes 4444 processing on Apple
  Silicon systems. This version requires a DaVinci Resolve Studio license dongle or software activation code.

...
def item_candidate(item: dict[str, Any], *, site: str, source_type: str,
    ...
    return {
        ...
        # The API's creation_date IS when the question was asked -- unlike an HTML listing stamp,
        # it does not move when somebody answers -- so it is already the original post date.
        "original_post_date": source_date,

...
const profiles = {
  ...
  "bea-industry": { readiness: "CANDIDATE_DATASET", authority: "U.S. Bureau of Economic Analysis", dataset: "GDP by Industry", cadence: "Quarterly / annual", summary: "Official industry output, value-added, and integrated industry-account records.", evidenceUrl: "https://www.bea.gov/data/gdp/gdp-industry", methodologyUrl: "https://www.bea.gov/resources/methodologies/industry-economic-accounts", registrationState: "CANDIDATE_NOT_REGISTERED" },
  ...
  "census-bds": { readiness: "CANDIDATE_DATASET", authority: "U.S. Census Bureau", dataset: "Business Dynamics Statistics", cadence: "Annual", summary: "Official firm and establishment births, deaths, job creation, and job destruction records.", evidenceUrl: "https://www.census.gov/programs-surveys/bds.html", registrationState: "CANDIDATE_NOT_REGISTERED" },
  ...
  "bls-ppi": { readiness: "CANDIDATE_DATASET", authority: "U.S. Bureau of Labor Statistics", dataset: "Producer Price Index", cadence: "Monthly", summary: "Official producer selling-price indexes by industry and commodity.", evidenceUrl: "https://www.bls.gov/ppi/", methodologyUrl: "https://www.bls.gov/opub/hom/ppi/", registrationState: "CANDIDATE_NOT_REGISTERED" },
  ...
  "uscourts-f2": { readiness: "CANDIDATE_DATASET", authority: "Administrative Office of the U.S. Courts", dataset: "Table F-2, U.S. Bankruptcy Courts", cadence: "Quarterly rolling 12-month", summary: "Official business and nonbusiness bankruptcy filing counts by chapter.", evidenceUrl: "https://www.uscourts.gov/data-news/reports/statistical-reports/bankruptcy-filings-statistics", methodologyUrl: "https://www.uscourts.gov/data-news/data-tables/data-definitions", registrationState: "CANDIDATE_NOT_REGISTERED" },
...
assign("dol-claims", ["Initial Claims", "Initial UI Claims", "Continued Claims", "Continued Claims / Insured Unemployment"]);
...
assign("bls-jolts", ["Layoffs & Discharges", "Job Openings Rate", "Hires Rate", "Industry Layoffs & Discharges"]);
assign("bls-ces", ["Payroll Growth", "Industry Payroll Contraction", "Regional Employment Growth"]);
assign("bls-bed", ["Closing Establishment Losses", "Establishment Closures", "Establishment Contractions", "Establishment Deaths", "Establishment Death / Closure Losses", "Industry Gross Job Losses"]);
assign("census-bfs", ["Business Formations"]);
assign("census-bds", ["Business Formation / Dynamism", "Firm Age / Size", "Firm Age / Size Vulnerability", "Firm Deaths", "Firm Death / Shutdown Stress"]);
assign("fed-h15", ["Interest Rates", "Borrowing Costs"]);
assign("fed-sloos", ["C&I Credit Conditions", "C&I Lending Standards", "C&I Loan Demand", "Industry Credit Conditions"]);
assign("bls-productivity", ["Productivity / Automation", "Industry Unit Labor Costs"]);
assign("bls-ppi", ["Input Costs", "Producer Input Costs", "Producer Input Prices", "Industry Input Prices"]);
assign("census-trade", ["Import / Trade Pressure", "Trade / Import Pressure", "Import Exposure", "Trade / External Shock"]);
assign("uscourts-f2", ["Business Bankruptcy Filings", "Business Bankruptcy Stress", "Business Failure / Bankruptcy Stress", "Business Failure Stress"]);
assign("bea-industry", ["Industry Output"]);
assign("census-economic", ["New Orders", "Inventory / Sales Balance", "Inventory / Sales Imbalance", "Inventory / Sales Ratio", "Sales / Revenue", "Sales / Revenue Growth", "Industry Sales / Shipments", "Industry New Orders"]);
assign("bea-nipa", ["Real Output Growth", "Consumer Demand", "Consumer Spending", "Corporate Profits", "Corporate Profitability"]);
assign("fed-g17", ["Industry Capacity Utilization"]);
assign("eia-open", ["Energy / Input Shock"]);
...
assign("design-required", ["Disaster / External Shock", "Disaster / Operational Shock", "Disaster / Weather Shock"]);
